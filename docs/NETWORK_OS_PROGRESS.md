...
| M3: Today and reconnecting | In progress | Due queue groups dated commitments before routine plans; open-loop controls implemented; preferences, personal updates and optional grounded drafts remain |
...
## M3 dated commitments — verified slice
