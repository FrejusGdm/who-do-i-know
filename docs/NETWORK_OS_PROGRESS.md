...
| M3: Today and reconnecting | In progress | Due queue groups dated commitments before routine plans; open-loop controls implemented; conversation preferences implemented; personal updates and optional grounded drafts remain |
...
## M3 conversation preferences — verified slice
